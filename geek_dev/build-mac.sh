...
if [ "$ARCH" == "arm64" ]; then
  ...
  # opencode build script creates dist/opencode-darwin-arm64/bin/opencode
  CLI_SOURCE="dist/opencode-darwin-arm64/bin/opencode"
else
  RUST_TARGET="x86_64-apple-darwin"
  CLI_SOURCE="dist/opencode-darwin-x64/bin/opencode"
fi
