...
import { MemoryItem } from "../core/memory-system"

interface ThinkStreamProps {
  items: MemoryItem[]
  connected?: boolean
}

const ThinkStream: Component<ThinkStreamProps> = (props) => {
  const isConnected = () => props.connected ?? false

  return (
    <footer class="h-64 border-t border-white/10 glass-panel p-6 bg-[#0B0E14]/80 backdrop-blur-2xl flex flex-col relative overflow-hidden">
