const Header = (props) => {
    ...
    return (<header class="h-20 border-b border-white/10 flex items-center px-10 justify-between bg-[#0A0E1A]/60 backdrop-blur-md z-50 overflow-hidden relative">
      ...
      <div class="flex items-center space-x-4">
        <div class="relative">
          ...
          <div class="absolute -top-1 -right-1 w-3 h-3 rounded-full border-2 border-[#0A0E1A]" classList={{
      ...
      <div class="flex items-center space-x-6">
        <div class="px-4 py-2 rounded-lg border flex items-center space-x-2" classList={{
          ...
          <span class="text-xs font-mono font-bold" classList={{
